...
class BarBarGUI(Tk):
    ...
    def error(self, error_label, city_map):
    ...
    def search_page(self):
        ...
        city_map = Canvas(self, width=700, bd=3, relief=GROOVE, bg=self.color)
        ...
        self.var.set("Held-Karp")
        choice1 = AlgoRadioButton(control_panel, "Held-Karp", self.var, self.font_color, self.color)
        choice1.pack()

        choice2 = AlgoRadioButton(control_panel, "Another", self.var, self.font_color, self.color)
        choice2.pack()

        choice3 = AlgoRadioButton(control_panel, "Another one", self.var, self.font_color, self.color)
        choice3.pack()
        ...
        validate_choice = GlobalButton(control_panel, self.font_color, self.color, text="NEXT",
                                       command=lambda: self.error(error_label, city_map))
